...
var Peer = class extends Remote {
	...
	sendProposal(proposal, timeout) {
		logger.debug('Peer.sendProposal - Start' + this);
		let self = this;
      ...
      logger.debug('proposal header: %j' , proposal.header);
            ...
            logger.debug('Received proposal response: ' + proposalResponse.response.payload)
